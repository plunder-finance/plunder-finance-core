 ...
 */
contract PlunderVault is ERC20, Ownable, ReentrancyGuard {
    ...
    */
     ...
     * Never invest in a Plunder Vault with tokens you don't trust.
     * Never invest in a Plunder Vault with tokens whose rules for minting you don’t agree with.
     * Ensure the accuracy of the contracts for the tokens in the Plunder Vault.
     * Ensure the accuracy of the contracts for the Plunder Vault and Strategy you are depositing in.
