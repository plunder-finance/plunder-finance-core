...
contract StrategyMdexChefLP is StratManager, FeeManager, GasThrottler {
    ...
    function rewardsAvailable() public view returns (uint256 rewards) {
        (rewards,) = IMasterChef(chef).pending(poolId, address(this));
    }
